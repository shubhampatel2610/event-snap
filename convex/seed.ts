...
Light refreshments will be provided. Limited seats available.`,
        ...
        city: "Bangalore",
        state: "Karnataka",
        venueName: "https://maps.google.com/?q=WeWork+Embassy+Golf+Links",
...
Pizza and drinks provided!`,
        ...
        city: "Hyderabad",
        state: "Telangana",
        venueName: "https://maps.google.com/?q=T-Hub+Hyderabad",
...
Food and beverages available for purchase at the venue.`,
        ...
        city: "Mumbai",
        state: "Maharashtra",
        venueName: "https://maps.google.com/?q=The+Habitat+Khar",
...
Continental breakfast included in registration.`,
        ...
        city: "Gurgaon",
        state: "Haryana",
        venueName: "https://maps.google.com/?q=91springboard+Gurgaon",
...
Chai stops included along the way!`,
        ...
        city: "Delhi",
        state: "Delhi",
        venueName: "https://maps.google.com/?q=Red+Fort+Delhi",
...
Laptop required. Course materials provided.`,
        ...
        city: "Pune",
        state: "Maharashtra",
        venueName: "https://maps.google.com/?q=Cummins+College+Pune",
...
Referee provided. Water and energy drinks available. Medical support on standby.`,
        ...
        city: "Chennai",
        state: "Tamil Nadu",
        venueName: "https://maps.google.com/?q=Jawaharlal+Nehru+Stadium+Chennai",
...
Taste everything you cook! Great for health enthusiasts and curious foodies alike.`,
        ...
        city: "Kolkata",
        state: "West Bengal",
        venueName: "https://maps.google.com/?q=Salt+Lake+Kolkata",
...
Yoga mats provided. Please wear comfortable clothing.`,
        ...
        city: "Jaipur",
        state: "Rajasthan",
        venueName: "https://maps.google.com/?q=Central+Park+Jaipur",
...
Energy drinks and snacks available. Exciting commentary and crowd interaction!`,
        ...
        city: "Noida",
        state: "Uttar Pradesh",
        venueName: "https://maps.google.com/?q=DLF+Mall+Noida",
...
Open to all genders. Q&A session and networking lunch included.`,
        ...
        city: "Bangalore",
        state: "Karnataka",
        venueName: "https://maps.google.com/?q=Google+Office+Bangalore",
...
Transport from Delhi available at additional cost.`,
        ...
        venueName: "https://maps.google.com/?q=McLeod+Ganj",
...
Refreshments provided. A great way to give back to nature while meeting like-minded people!`,
        ...
        city: "Goa",
        state: "Goa",
        venueName: "https://maps.google.com/?q=Calangute+Beach+Goa",
...
Code examples and cheat sheets provided.`,
        ...
        city: "Ahmedabad",
        state: "Gujarat",
        venueName: "https://maps.google.com/?q=IIM+Ahmedabad",
...
Sleeping bags welcome. Food and drinks provided throughout.`,
        ...
        city: "Bangalore",
        state: "Karnataka",
        venueName: "https://maps.google.com/?q=Bangalore+International+Centre",
...
Lunch and refreshments included. Bring your laptop!`,
        ...
        city: "Gurgaon",
        state: "Haryana",
        venueName: "https://maps.google.com/?q=Innov8+Cyber+Hub+Gurgaon",
...
Continental breakfast and unlimited coffee included!`,
        ...
        city: "Gurgaon",
        state: "Haryana",
        venueName: "https://maps.google.com/?q=WeWork+Two+Horizon+Center+Gurgaon",
...
Snacks and beverages provided both days.`,
        ...
        city: "Gurgaon",
        state: "Haryana",
        venueName: "https://maps.google.com/?q=Visual+Arts+Gallery+Gurgaon",
...
Perfect for team building and corporate bonding!`,
        ...
        city: "Gurgaon",
        state: "Haryana",
        venueName: "https://maps.google.com/?q=Tau+Devi+Lal+Stadium+Gurgaon",
...
Healthy snacks and herbal teas included.`,
        ...
        city: "Gurgaon",
        state: "Haryana",
        venueName: "https://maps.google.com/?q=The+Yoga+Studio+Gurgaon",
    ...
    },
    {
        ...
        city: "Gurgaon",
        state: "Haryana",
        venueName: "https://maps.app.goo.gl/YXJ5J2eCVWbskBSL9",
        address:
    ...
    },
    {
        ...
        city: "Gurgaon",
        state: "Haryana",
        venueName: "https://maps.app.goo.gl/tgdtbwXkAwpHkHAw6",
        address:
...
function getEventEndTime(startTime: any) {
    ...
    handler: async (ctx) => {
        ...
        for (const eventData of SAMPLE_EVENTS) {
            ...
            const event = {
                ...
                country: "India",
                registrationCount,
                attendeesCount: registrationCount,
                isFree: eventData.isFree,
                createdAt: Date.now(),
                updatedAt: Date.now(),
            };

            const eventId = await ctx.db.insert("eventsData", event);
...
export const clear = internalMutation({
    handler: async (ctx) => {
        const events = await ctx.db.query("eventsData").collect();
        let count = 0;
